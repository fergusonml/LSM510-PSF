...
#a=pd.read_excel('200nmbead1.xlsx','Sheet1',header=None)
#a.plot(x=0,y=1)
...
#from read_xlsx3 import *
#a=read_xlsx3('200nmbeadlsmpsfvalues.xlsx','Sheet1')
a=pd.read_excel('200nmbead1.xlsx','Sheet3',header=None)
